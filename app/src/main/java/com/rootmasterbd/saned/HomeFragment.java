...
public class HomeFragment {
    private TextView tvOryon,tvCpu,tvGpu,tvHz,tvFps,tvJahez,tvSaned,tvMaps;
    private TextView tvNetMs,tvJahezMs,tvDl,tvUl,tvWakelock,tvGps,tvKa,tvBg,tvLog,tvMode;
    ...
    public HomeFragment(View v, Handler h, ExecutorService e, TextView modeTV) {
        ...
        tvOryon = v.findViewById(R.id.tvOryon);
        tvCpu = v.findViewById(R.id.tvCpu);
        tvGpu = v.findViewById(R.id.tvGpu);
        tvHz = v.findViewById(R.id.tvHz);
        tvFps = v.findViewById(R.id.tvFps);
        tvJahez = v.findViewById(R.id.tvJahez);
        tvSaned = v.findViewById(R.id.tvSaned);
        tvMaps = v.findViewById(R.id.tvMaps);
        tvNetMs = v.findViewById(R.id.tvNetMs);
        tvJahezMs = v.findViewById(R.id.tvJahezMs);
        tvDl = v.findViewById(R.id.tvDl);
        tvUl = v.findViewById(R.id.tvUl);
        tvWakelock = v.findViewById(R.id.tvWakelock);
        tvGps = v.findViewById(R.id.tvGps);
        tvKa = v.findViewById(R.id.tvKa);
        tvBg = v.findViewById(R.id.tvBg);
        tvLog = v.findViewById(R.id.tvLog);
        btnB = v.findViewById(R.id.btnBalanced);
        btnP = v.findViewById(R.id.btnPerformance);
        btnG = v.findViewById(R.id.btnGaming);

        btnB.setBackgroundColor(Color.parseColor("#00FF88")); btnB.setTextColor(Color.BLACK);
        btnP.setBackgroundColor(Color.parseColor("#0A1628")); btnP.setTextColor(Color.parseColor("#00B4FF"));
        btnG.setBackgroundColor(Color.parseColor("#0A1628")); btnG.setTextColor(Color.parseColor("#FF8C00"));
    ...
    private void setMode(String m) {
        exec.execute(() -> {
            ...
            handler.post(() -> updateButtons(m));
        });
    }

    private void updateButtons(String m) {
    ...
    private void update(Map<String,String> d) {
        ...
        tvGpu.setText("GPU: "+d.getOrDefault("GPU","---")+"%");
        tvHz.setText(d.getOrDefault("HZ","---")+"Hz");
        tvFps.setText("FPS: "+d.getOrDefault("FPS","---"));
        setApp(tvJahez,"Jahez",d.getOrDefault("JAHEZ","Inactive"));
        setApp(tvSaned,"Saned",d.getOrDefault("SANED","Inactive"));
        ...
        setSt(tvWakelock,"Wakelock",d.getOrDefault("WAKELOCK","---"),"ON");
        setSt(tvGps,"GPS",d.getOrDefault("GPS","---"),"HIGH_ACC");
